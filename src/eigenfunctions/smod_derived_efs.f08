...
contains
  ...
  module procedure calculate_derived_eigenfunctions
    ...
    do i = 1, size(ef_written_idxs)
      ...
      v1_ef = retrieve_eigenfunction_from_index( &
        name="v1", ef_index=i, state_vector=state_vector &
      )
      v2_ef = retrieve_eigenfunction_from_index( &
        name="v2", ef_index=i, state_vector=state_vector &
      )
      v3_ef = retrieve_eigenfunction_from_index( &
        name="v3", ef_index=i, state_vector=state_vector &
      )
      a1_ef = retrieve_eigenfunction_from_index( &
        name="a1", ef_index=i, state_vector=state_vector &
      )
      a2_ef = retrieve_eigenfunction_from_index( &
        name="a2", ef_index=i, state_vector=state_vector &
      )
      a3_ef = retrieve_eigenfunction_from_index( &
        name="a3", ef_index=i, state_vector=state_vector &
      )
  ...
  subroutine set_entropy(loc, ef_index, state_vector)
    ...
    rho_ef = retrieve_eigenfunction_from_index( &
      name="rho", ef_index=ef_index, state_vector=state_vector &
    )
    T_ef = retrieve_eigenfunction_from_index( &
      name="T", ef_index=ef_index, state_vector=state_vector &
    )
  ...
  subroutine set_velocity_divergence(loc, ef_index, rvec, state_vector)
    !> position index in the main array
    integer, intent(in) :: loc
    !> index of the eigenfunction in the "quantities" array attribute
    integer, intent(in) :: ef_index
  ...
  subroutine set_velocity_curl(loc, ef_index, rvec, state_vector)
  ...
  subroutine set_magnetic_field_curl(loc, ef_index, rvec, state_vector)
    !> position indices in the main array
    integer, intent(in) :: loc(3)
    !> index of the eigenfunction in the "quantities" array attribute
    integer, intent(in) :: ef_index
