...
contains
  ...
  module procedure add_natural_conduction_terms
    ...
    positions(3, :) = [5, 6]
    call subblock(quadblock, factors, positions, weight, h_quad, h_quad, dim_subblock)
    ...
    positions(1, :) = [5, 5]
    call subblock(quadblock, factors, positions, weight, h_quad, dh_quad, dim_subblock)
    ...
    positions(2, :) = [5, 8]
    call subblock(quadblock, factors, positions, weight, h_quad, h_cubic, dim_subblock)
    ...
    positions(2, :) = [5, 8]
    call subblock(quadblock, factors, positions, weight, h_quad, dh_cubic, dim_subblock)
